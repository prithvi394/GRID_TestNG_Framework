...
public class WebShopSignInTest4 extends BaseGrid {
	
  @Parameters("browser")
  public WebShopSignInTest4(String browser) throws MalformedURLException {
	  	super(browser);
		// TODO Auto-generated constructor stub
	}
  
  Logger stdLog = LogManager.getLogger(WebShopSignInTest4.class);
