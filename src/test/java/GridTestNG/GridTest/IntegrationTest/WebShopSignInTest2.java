...
public class WebShopSignInTest2 extends BaseGrid {
	
  @Parameters("browser")
  public WebShopSignInTest2(String browser) throws MalformedURLException {
	  	super(browser);
		// TODO Auto-generated constructor stub
	}
  
  Logger stdLog = LogManager.getLogger(WebShopSignInTest2.class);
